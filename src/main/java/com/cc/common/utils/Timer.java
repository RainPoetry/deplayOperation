 ...
 * This class also ensures monotonic(单调) updates to the timer even if the underlying clock is subject
 ...
 * waiting a request sent through the  should call
 * following each blocking call to
